"use strict";(()=>{var e={};e.id=912,e.ids=[912],e.modules={53524:e=>{e.exports=require("@prisma/client")},85890:e=>{e.exports=require("better-sqlite3")},72934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},54580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},45869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},27790:e=>{e.exports=require("assert")},78893:e=>{e.exports=require("buffer")},61282:e=>{e.exports=require("child_process")},84770:e=>{e.exports=require("crypto")},17702:e=>{e.exports=require("events")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},19801:e=>{e.exports=require("os")},55315:e=>{e.exports=require("path")},86624:e=>{e.exports=require("querystring")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},57109:(e,t,n)=>{n.r(t),n.d(t,{originalPathname:()=>g,patchFetch:()=>h,requestAsyncStorage:()=>f,routeModule:()=>c,serverHooks:()=>m,staticGenerationAsyncStorage:()=>d});var r={};n.r(r),n.d(r,{GET:()=>p,POST:()=>p});var i=n(49303),o=n(88716),a=n(60670),s=n(75571),l=n.n(s),u=n(90455);let p=l()(u.L),c=new i.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/api/auth/[...nextauth]/route",pathname:"/api/auth/[...nextauth]",filename:"route",bundlePath:"app/api/auth/[...nextauth]/route"},resolvedPagePath:"E:\\Web\\devroot\\PTZ_www\\integrated\\20260302-1403-Base\\ptzcontroller_admin\\app\\api\\auth\\[...nextauth]\\route.ts",nextConfigOutput:"standalone",userland:r}),{requestAsyncStorage:f,staticGenerationAsyncStorage:d,serverHooks:m}=c,g="/api/auth/[...nextauth]/route";function h(){return(0,a.patchFetch)({serverHooks:m,staticGenerationAsyncStorage:d})}},90455:(e,t,n)=>{n.d(t,{L:()=>c});var r=n(53797),i=n(13539),o=n(9487),a=n(42023),s=n.n(a),l=n(66610),u=n(48843);try{(0,l.g0)(),console.log("[Auth] Offline DB initialized successfully")}catch(e){console.warn("[Auth] Offline DB initialization failed (non-critical):",e)}let p="true"===process.env.PTZ_DESKTOP_MODE,c={adapter:(0,i.N)(o.prisma),providers:[(0,r.Z)({name:"Credentials",credentials:{email:{label:"Email",type:"email"},password:{label:"Password",type:"password"}},async authorize(e){if(!e?.email||!e?.password)return console.warn("[Auth] Missing email or password"),null;let t=p?"Desktop":"Admin";try{console.log(`[Auth] Online login attempt (${t}):`,e.email);let n=await Promise.race([o.prisma.user.findUnique({where:{email:e.email},select:{id:!0,email:!0,name:!0,password:!0,role:!0,organization:!0,approved:!0}}),new Promise(e=>setTimeout(()=>e(null),3e3))]);if(n&&n.password&&await s().compare(e.password,n.password)){console.log(`[Auth] OK Online login success (${t}):`,e.email);try{await (0,l.en)({email:n.email,name:n.name||"User",organization:n.organization||void 0,passwordHash:n.password,role:n.role||"user",lastOnlineLoginAt:new Date().toISOString(),lastSyncAt:new Date().toISOString(),platform:process.platform,appVersion:process.env.npm_package_version}),console.log("[Auth] OK Offline DB sync:",e.email)}catch(e){console.warn("[Auth] WARN Offline DB sync failed:",e)}return{id:n.id,email:n.email,name:n.name,role:n.role,organization:n.organization??"",approved:n.approved??!1}}}catch(e){console.log(`[Auth] Online DB unavailable (${t}):`,e instanceof Error?e.message:String(e))}if(p){console.log("[Auth] Desktop offline fallback attempt:",e.email);try{let t=await (0,u.TA)();if(!t.valid)return console.warn("[Auth] FAIL Desktop offline: no valid license, reason:",t.reason),null;console.log("[Auth] OK Desktop license verified:",t.expiresAt);let n=await (0,l.Zz)(e.email,e.password,s());if(n)return console.log("[Auth] OK Desktop offline login success (license + local DB):",e.email),(0,l.LN)(n.email,!0),{id:n.id,email:n.email,name:n.name,role:n.role,approved:!0};console.warn("[Auth] FAIL Desktop offline login: password mismatch")}catch(e){console.error("[Auth] ERROR Desktop offline auth error:",e instanceof Error?e.message:String(e))}}else console.warn("[Auth] FAIL Admin online auth failed, no offline fallback:",e.email);return null}})],session:{strategy:"jwt",maxAge:86400},callbacks:{jwt:async({token:e,user:t})=>(t&&(e.role=t?.role??"user",e.id=t?.id,e.organization=t?.organization??"",e.approved=t?.approved??!1),e),session:async({session:e,token:t})=>(e?.user&&(e.user.role=t?.role,e.user.id=t?.id,e.user.organization=t?.organization??"",e.user.approved=t?.approved??!1),e)},pages:{signIn:"/login"},secret:process.env.NEXTAUTH_SECRET}},66610:(e,t,n)=>{n.d(t,{LN:()=>A,Zz:()=>h,en:()=>g,g0:()=>f});var r=n(85890),i=n.n(r),o=n(55315),a=n.n(o),s=n(19801),l=n.n(s),u=n(92048),p=n.n(u);let c=null;function f(){try{let e;let t=("win32"===process.platform?e=a().join(process.env.PROGRAMDATA||"C:\\ProgramData","PTZController"):"darwin"===process.platform?e=a().join(process.env.HOME||l().homedir(),"Library/Application Support/PTZController"):e=a().join(process.env.HOME||l().homedir(),".config/PTZController"),p().existsSync(e)||p().mkdirSync(e,{recursive:!0}),a().join(e,"offline.db"));(c=new(i())(t)).pragma("journal_mode = WAL"),c.pragma("synchronous = NORMAL"),c.exec(`
    ...
    `).run(n,e.email,e.name,e.organization??null,e.passwordHash,e.role,e.machineId??null,e.lastMachineId??null,e.licenseStatus??null,e.licenseExpiresAt??null,e.lastOnlineLoginAt??null,e.lastSyncAt??null,e.isInOfflineMode??0,e.offlineSessionToken??null,e.offlineStartedAt??null,e.platform??null,e.appVersion??null,e.failedLoginAttempts??0,e.lastFailedLoginAt??null,e.lockedUntil??null,e.isActive??1,e.createdAt??r,r),m(e.email)}async function h(e,t,n){let r=m(e);if(!r)return console.warn("[OfflineDB] 사용자 없음:",e),null;if(r.lockedUntil&&new Date(r.lockedUntil)>new Date)return console.warn("[OfflineDB] 계정 잠금 (해제 시간):",r.lockedUntil),null;if(1!==r.isActive)return console.warn("[OfflineDB] 비활성 계정:",e),null;try{if(!await n.compare(t,r.passwordHash)){let t=(r.failedLoginAttempts??0)+1,n=t>=5;return d().prepare(`
                UPDATE offline_users
                SET 
                    failedLoginAttempts = ?,
                    lastFailedLoginAt = ?,
