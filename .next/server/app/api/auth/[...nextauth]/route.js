"use strict";(()=>{var e={};e.id=912,e.ids=[912],e.modules={53524:e=>{e.exports=require("@prisma/client")},85890:e=>{e.exports=require("better-sqlite3")},72934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},54580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},45869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},27790:e=>{e.exports=require("assert")},78893:e=>{e.exports=require("buffer")},61282:e=>{e.exports=require("child_process")},84770:e=>{e.exports=require("crypto")},17702:e=>{e.exports=require("events")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},19801:e=>{e.exports=require("os")},55315:e=>{e.exports=require("path")},86624:e=>{e.exports=require("querystring")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},57109:(e,t,n)=>{n.r(t),n.d(t,{originalPathname:()=>h,patchFetch:()=>g,requestAsyncStorage:()=>d,routeModule:()=>c,serverHooks:()=>m,staticGenerationAsyncStorage:()=>f});var r={};n.r(r),n.d(r,{GET:()=>p,POST:()=>p});var i=n(49303),o=n(88716),s=n(60670),a=n(75571),l=n.n(a),u=n(90455);let p=l()(u.L),c=new i.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/api/auth/[...nextauth]/route",pathname:"/api/auth/[...nextauth]",filename:"route",bundlePath:"app/api/auth/[...nextauth]/route"},resolvedPagePath:"E:\\Web\\devroot\\PTZ_www\\integrated\\20260302-1403-Base\\ptzcontroller_admin\\app\\api\\auth\\[...nextauth]\\route.ts",nextConfigOutput:"standalone",userland:r}),{requestAsyncStorage:d,staticGenerationAsyncStorage:f,serverHooks:m}=c,h="/api/auth/[...nextauth]/route";function g(){return(0,s.patchFetch)({serverHooks:m,staticGenerationAsyncStorage:f})}},90455:(e,t,n)=>{n.d(t,{L:()=>p});var r=n(53797),i=n(13539),o=n(9487),s=n(42023),a=n.n(s),l=n(66610),u=n(48843);try{(0,l.g0)(),console.log("[Auth] Offline DB initialized successfully")}catch(e){console.warn("[Auth] Offline DB initialization failed (non-critical):",e)}let p={adapter:(0,i.N)(o.prisma),providers:[(0,r.Z)({name:"Credentials",credentials:{email:{label:"Email",type:"email"},password:{label:"Password",type:"password"}},async authorize(e){if(!e?.email||!e?.password)return console.warn("[Auth] Missing email or password"),null;try{console.log("[Auth] 온라인 로그인 시도:",e.email);let t=await Promise.race([o.prisma.user.findUnique({where:{email:e.email},select:{id:!0,email:!0,name:!0,password:!0,role:!0,organization:!0}}),new Promise(e=>setTimeout(()=>e(null),3e3))]);if(t&&t.password&&await a().compare(e.password,t.password)){console.log("[Auth] ✅ 온라인 로그인 성공:",e.email);try{let e=await (0,l.en)({email:t.email,name:t.name||"User",organization:t.organization||void 0,passwordHash:t.password,role:t.role||"user",lastOnlineLoginAt:new Date().toISOString(),lastSyncAt:new Date().toISOString(),platform:process.platform,appVersion:process.env.npm_package_version});console.log("[Auth] ✅ 오프라인 DB 저장 완료:",e.email)}catch(e){console.error("[Auth] ❌ 오프라인 DB 저장 실패:",e)}return{id:t.id,email:t.email,name:t.name,role:t.role}}}catch(e){console.error("[Auth] 온라인 DB 에러:",e instanceof Error?e.message:String(e))}console.log("[Auth] 오프라인 로그인 시도 중...");try{let t=await (0,u.verifyOfflineLicense)();if(!t.valid)return console.warn("[Auth] ❌ 오프라인 로그인 거부: 유효한 라이선스 없음"),console.warn("[Auth] Reason:",t.reason),null;console.log("[Auth] ✅ 라이선스 검증 성공:",t.expiresAt);let n=await (0,l.Zz)(e.email,e.password,a());if(n)return console.log("[Auth] ✅ 오프라인 로그인 성공 (라이선스 있음):",e.email),(0,l.LN)(n.email,!0),{id:n.id,email:n.email,name:n.name,role:n.role};console.warn("[Auth] ❌ 오프라인 로그인 실패: 비밀번호 불일치")}catch(e){console.error("[Auth] 오프라인 인증 에러:",e instanceof Error?e.message:String(e))}return console.warn("[Auth] ❌ 로그인 실패 (온라인/오프라인 모두):",e.email),null}})],session:{strategy:"jwt",maxAge:86400},callbacks:{jwt:async({token:e,user:t})=>(t&&(e.role=t?.role??"user",e.id=t?.id),e),session:async({session:e,token:t})=>(e?.user&&(e.user.role=t?.role,e.user.id=t?.id),e)},pages:{signIn:"/login"},secret:process.env.NEXTAUTH_SECRET}},66610:(e,t,n)=>{n.d(t,{LN:()=>A,Zz:()=>g,en:()=>h,g0:()=>d});var r=n(85890),i=n.n(r),o=n(55315),s=n.n(o),a=n(19801),l=n.n(a),u=n(92048),p=n.n(u);let c=null;function d(){try{let e;let t=("win32"===process.platform?e=s().join(process.env.PROGRAMDATA||"C:\\ProgramData","PTZController"):"darwin"===process.platform?e=s().join(process.env.HOME||l().homedir(),"Library/Application Support/PTZController"):e=s().join(process.env.HOME||l().homedir(),".config/PTZController"),p().existsSync(e)||p().mkdirSync(e,{recursive:!0}),s().join(e,"offline.db"));(c=new(i())(t)).pragma("journal_mode = WAL"),c.pragma("synchronous = NORMAL"),c.exec(`
    ...
    `),console.log("[OfflineDB] Initialized at:",t)}catch(e){throw console.error("[OfflineDB] Initialization failed:",e),e}}function f(){return c||d(),c}function m(e){return f().prepare("SELECT * FROM offline_users WHERE email = ?").get(e)??null}function h(e){let t=f(),n=e.id||`offline-${Date.now()}-${Math.random().toString(36).substr(2,9)}`,r=new Date().toISOString();return m(e.email)?t.prepare(`
    ...
    `).run(n,e.email,e.name,e.organization??null,e.passwordHash,e.role,e.machineId??null,e.lastMachineId??null,e.licenseStatus??null,e.licenseExpiresAt??null,e.lastOnlineLoginAt??null,e.lastSyncAt??null,e.isInOfflineMode??0,e.offlineSessionToken??null,e.offlineStartedAt??null,e.platform??null,e.appVersion??null,e.failedLoginAttempts??0,e.lastFailedLoginAt??null,e.lockedUntil??null,e.isActive??1,e.createdAt??r,r),m(e.email)}async function g(e,t,n){let r=m(e);if(!r)return console.warn("[OfflineDB] 사용자 없음:",e),null;if(r.lockedUntil&&new Date(r.lockedUntil)>new Date)return console.warn("[OfflineDB] 계정 잠금 (해제 시간):",r.lockedUntil),null;if(1!==r.isActive)return console.warn("[OfflineDB] 비활성 계정:",e),null;try{if(!await n.compare(t,r.passwordHash)){let t=(r.failedLoginAttempts??0)+1,n=t>=5;return f().prepare(`
                ...
                SET 
                    ...
                    lockedUntil = ?
                WHERE email = ?
            `).run(t,new Date().toISOString(),n?new Date(Date.now()+18e5).toISOString():null,e),console.warn("[OfflineDB] ❌ 비밀번호 불일치:",e,`(${t}/5)`),null}return f().prepare(`
            UPDATE offline_users
            SET 
                ...
                updatedAt = ?
            WHERE email = ?
        `).run(new Date().toISOString(),new Date().toISOString(),new Date().toISOString(),e),console.log("[OfflineDB] ✅ 오프라인 로그인 성공:",e),m(e)}catch(e){return console.error("[OfflineDB] bcrypt 비교 에러:",e instanceof Error?e.message:String(e)),null}}function A(e,t,n){f().prepare(`
    UPDATE offline_users
    SET 
      isInOfflineMode = ?,
      offlineStartedAt = ?,
