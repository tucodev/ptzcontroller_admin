"use strict";(()=>{var e={};e.id=912,e.ids=[912],e.modules={53524:e=>{e.exports=require("@prisma/client")},85890:e=>{e.exports=require("better-sqlite3")},72934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},54580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},45869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},27790:e=>{e.exports=require("assert")},78893:e=>{e.exports=require("buffer")},84770:e=>{e.exports=require("crypto")},17702:e=>{e.exports=require("events")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},19801:e=>{e.exports=require("os")},55315:e=>{e.exports=require("path")},86624:e=>{e.exports=require("querystring")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},57109:(e,t,n)=>{n.r(t),n.d(t,{originalPathname:()=>h,patchFetch:()=>g,requestAsyncStorage:()=>d,routeModule:()=>c,serverHooks:()=>m,staticGenerationAsyncStorage:()=>f});var r={};n.r(r),n.d(r,{GET:()=>p,POST:()=>p});var i=n(49303),o=n(88716),s=n(60670),a=n(75571),l=n.n(a),u=n(38961);let p=l()(u.L),c=new i.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/api/auth/[...nextauth]/route",pathname:"/api/auth/[...nextauth]",filename:"route",bundlePath:"app/api/auth/[...nextauth]/route"},resolvedPagePath:"E:\\Web\\devroot\\PTZ_www\\integrated\\20260302-1403-Base\\ptzcontroller_admin\\app\\api\\auth\\[...nextauth]\\route.ts",nextConfigOutput:"standalone",userland:r}),{requestAsyncStorage:d,staticGenerationAsyncStorage:f,serverHooks:m}=c,h="/api/auth/[...nextauth]/route";function g(){return(0,s.patchFetch)({serverHooks:m,staticGenerationAsyncStorage:f})}},38961:(e,t,n)=>{n.d(t,{L:()=>y});var r=n(53797),i=n(13539),o=n(9487),s=n(42023),a=n.n(s),l=n(85890),u=n.n(l),p=n(55315),c=n.n(p),d=n(19801),f=n.n(d),m=n(92048),h=n.n(m);let g=null;function A(){try{let e;let t=("win32"===process.platform?e=c().join(process.env.PROGRAMDATA||"C:\\ProgramData","PTZController"):"darwin"===process.platform?e=c().join(process.env.HOME||f().homedir(),"Library/Application Support/PTZController"):e=c().join(process.env.HOME||f().homedir(),".config/PTZController"),h().existsSync(e)||h().mkdirSync(e,{recursive:!0}),c().join(e,"offline.db"));(g=new(u())(t)).pragma("journal_mode = WAL"),g.pragma("synchronous = NORMAL"),g.exec(`
    ...
    `),console.log("[OfflineDB] Initialized at:",t)}catch(e){throw console.error("[OfflineDB] Initialization failed:",e),e}}function T(){return g||A(),g}function E(e){return T().prepare("SELECT * FROM offline_users WHERE email = ?").get(e)??null}async function S(e,t,n){let r=E(e);if(!r)return console.warn("[OfflineDB] 사용자 없음:",e),null;if(r.lockedUntil&&new Date(r.lockedUntil)>new Date)return console.warn("[OfflineDB] 계정 잠금 (해제 시간):",r.lockedUntil),null;if(1!==r.isActive)return console.warn("[OfflineDB] 비활성 계정:",e),null;try{if(!await n.compare(t,r.passwordHash)){let t=(r.failedLoginAttempts??0)+1,n=t>=5;return T().prepare(`
                ...
                SET 
                    ...
                    lockedUntil = ?
                WHERE email = ?
            `).run(t,new Date().toISOString(),n?new Date(Date.now()+18e5).toISOString():null,e),console.warn("[OfflineDB] ❌ 비밀번호 불일치:",e,`(${t}/5)`),null}return T().prepare(`
            UPDATE offline_users
            SET 
                ...
                updatedAt = ?
            WHERE email = ?
        `).run(new Date().toISOString(),new Date().toISOString(),new Date().toISOString(),e),console.log("[OfflineDB] ✅ 오프라인 로그인 성공:",e),E(e)}catch(e){return console.error("[OfflineDB] bcrypt 비교 에러:",e instanceof Error?e.message:String(e)),null}}try{A(),console.log("[Auth] Offline DB initialized successfully")}catch(e){console.warn("[Auth] Offline DB initialization failed (non-critical):",e)}let y={adapter:(0,i.N)(o.prisma),providers:[(0,r.Z)({name:"Credentials",credentials:{email:{label:"Email",type:"email"},password:{label:"Password",type:"password"}},async authorize(e){if(!e?.email||!e?.password)return console.warn("[Auth] Missing email or password"),null;try{console.log("[Auth] 온라인 로그인 시도:",e.email);let t=await Promise.race([o.prisma.user.findUnique({where:{email:e.email},select:{id:!0,email:!0,name:!0,password:!0,role:!0,organization:!0}}),new Promise(e=>setTimeout(()=>e(null),3e3))]);if(t&&t.password&&await a().compare(e.password,t.password)){console.log("[Auth] ✅ 온라인 로그인 성공:",e.email);try{let e=await function(e){let t=T(),n=e.id||`offline-${Date.now()}-${Math.random().toString(36).substr(2,9)}`,r=new Date().toISOString();return E(e.email)?t.prepare(`
      UPDATE offline_users
      SET 
        name = ?,
        organization = ?,
    ...
    `).run(n,e.email,e.name,e.organization??null,e.passwordHash,e.role,e.machineId??null,e.lastMachineId??null,e.licenseStatus??null,e.licenseExpiresAt??null,e.lastOnlineLoginAt??null,e.lastSyncAt??null,e.isInOfflineMode??0,e.offlineSessionToken??null,e.offlineStartedAt??null,e.platform??null,e.appVersion??null,e.failedLoginAttempts??0,e.lastFailedLoginAt??null,e.lockedUntil??null,e.isActive??1,e.createdAt??r,r),E(e.email)}({email:t.email,name:t.name||"User",organization:t.organization||void 0,passwordHash:t.password,role:t.role||"user",lastOnlineLoginAt:new Date().toISOString(),lastSyncAt:new Date().toISOString(),platform:process.platform,appVersion:process.env.npm_package_version});console.log("[Auth] ✅ 오프라인 DB 저장 완료:",e.email)}catch(e){console.error("[Auth] ❌ 오프라인 DB 저장 실패:",e)}return{id:t.id,email:t.email,name:t.name,role:t.role}}}catch(e){console.error("[Auth] 온라인 DB 에러:",e instanceof Error?e.message:String(e))}console.log("[Auth] 오프라인 로그인 시도 중...");try{let n=await S(e.email,e.password,a());if(n){var t;return console.log("[Auth] ✅ 오프라인 로그인 성공:",e.email),t=n.email,T().prepare(`
    UPDATE offline_users
    SET 
      isInOfflineMode = ?,
      offlineStartedAt = ?,
